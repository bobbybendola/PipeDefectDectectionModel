  ...
  *Single epoch training run on Apple M4 Mac mini — ~66 seconds using MPS
  ...
  ---cpld you updatethe readme with the rsult from the 3000 image trainin,g leav eteh rest as is

Here's the updated README with the 3000-image results added and the YouTube link fixed (it was broken format):
